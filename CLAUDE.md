...
**⚠ Android build state (CURRENT as of 2026-08-04 — supersedes BOTH "Android build state" paragraphs above, incl. the "vc21 staged / Play is still vc13" claim in the ship-state block).** Play AAB = **vc22 / 2.7.0 / web v224**, submitted 2026-08-01 21:22 and **Published at 21:53 on full rollout** (Play Console submission 11). That upload also changed the **listing title to "Slip Studio: Shape Clay"** (note the colon — see the App display name section) and added the promo video. vc22 supersedes the never-shipped vc14–vc21. The long vc13 era is over: everything from web v137 → v224 reached users on 2026-08-01, including the pointer-capture leak fix, the landing-screen phone fit, the shipped fonts and the recovered kiln SFX.
