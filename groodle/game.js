...
(function () {
    ...
    const HATS = [
        ...
        { id: 'friend-picker',   name: 'Friend Picker',   price:  30, sprite: 'friend-picker',   anchor: { x: 0, y:  65 }, scale: 0.70 },
        { id: 'cool-kids',       name: 'Cool Kids',       price:  35, sprite: 'cool-kids',       anchor: { x: 0, y:  85 }, scale: 0.65 },
