...
hand-painted asset. ⚠ It HAS now drifted: the 2026-08-05 raster-page
shipment retired the SVG butterfly it renders — regenerate from one of
the real scenes when convenient (see the game's CLAUDE.md roadmap).
...
`templates.js` or `game.js` (currently v26).
