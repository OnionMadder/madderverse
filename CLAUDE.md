...
- **`main` = web v180 = LIVE + DEPLOYED** at madderverse.org/slip-studio/ (`index.html` reads `?v=180`). The **sculpting overhaul (2026-07-25, v171→v180)** landed and is live — see the "Sculpting overhaul" note at the very bottom. Everything through v170 (dated notes below) is also live.
