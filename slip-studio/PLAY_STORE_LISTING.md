...
## What's new  (v2.1 release — for history)
...
• Pinch twin amphora handles onto your pots. Drag them to widen, shift up or down, reshape until they read right. They follow your sculpt as you work.
• Sgraffito carving: scratch through the glaze with a needle to reveal the clay underneath, with real groove depth. Carved lines pass through the kiln intact.
• Two-glaze gradients: pour a second glaze and watch it pool from rim to foot, blending softly into the primary above.
• Clay feel deepened: heavier sculpting, push easier than pull, thin walls resist further pressure — closer to real wet stoneware.
• Lid silhouettes redesigned: flat is actually flat now, domed and tall are properly proportioned.
• New typography: Inter + Fraunces throughout.

Still no ads. Still no IAP. Still no internet needed.
```
...
- **Tags:** pottery, ceramics, art, creative, 3D, calm, meditative, sgraffito, gradient glaze
...
| Asset | Spec | Source / status |
|-------|------|-----------------|
| **7" tablet screenshots** | min 2, max 8 — 1080×1920 OR 1920×1080 ideal — same px range as phone | Same shots as phone but at tablet aspect. Capture from any Android tablet, or Chrome devtools at 1080×1920. |
