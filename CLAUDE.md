...
- **Next Play upload is versionCode 3, versionName "2.0"** (the local Capacitor wrap was last at vc2/vn1.1 = the live v1.1 build). Bump these in `slip-studio-app/android/app/build.gradle` when running step 4 of the rebuild recipe above.
